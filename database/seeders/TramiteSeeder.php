...
class TramiteSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        tramite::create(['tramite_id'=>5,'tipo_id'=> 3,'orientadora_id'=> 4,'alumno_id'=> 1]);   
        # 5
        ...
        tramite::create(['tramite_id'=>8,'tipo_id'=> 3,'orientadora_id'=> 5,'alumno_id'=> 1]);   
        ...
        # 10 
        tramite::create(['tramite_id'=>11,'tipo_id'=> 3,'orientadora_id'=> 5,'alumno_id'=> 1]);   
        tramite::create(['tramite_id'=>12,'tipo_id'=> 3,'orientadora_id'=> 4,'alumno_id'=> 1]);   
        tramite::create(['tramite_id'=>13,'tipo_id'=> 3,'orientadora_id'=> 4,'alumno_id'=> 1]);   
        tramite::create(['tramite_id'=>14,'tipo_id'=> 3,'orientadora_id'=> 4,'alumno_id'=> 1]);   
        tramite::create(['tramite_id'=>15,'tipo_id'=> 3,'orientadora_id'=> 4,'alumno_id'=> 1]);   
        # 15
